...
if DevAli:get(IrAq.."Ali:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAli:sadd(IrAq.."Ali:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevAli:get(IrAq.."Ali:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
IrAqName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if IrAqName then 
IrAqNames = DevAli:smembers(IrAq.."Ali:Mute:Names"..msg.chat_id_) or ""
if IrAqNames and IrAqNames[1] then 
for i=1,#IrAqNames do 
if IrAqName:match("(.*)("..IrAqNames[i]..")(.*)") then 
...
DevAli:set(IrAq.."Ali:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAli:del(IrAq.."Ali:Lock:MuteNames"..msg.chat_id_)
end
end
end

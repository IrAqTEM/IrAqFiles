ئlocal function TagAdmins(msg)
local text = msg.content_.text_
if ChatType == 'sp' or ChatType == 'gp'  then
if Manager(msg) then
if text == "admin" or text == "@admin" then
if DevAli:get(IrAq.."Ali:TagAdmins:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevAli:setex(IrAq..'Ali:TagAdmins:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
